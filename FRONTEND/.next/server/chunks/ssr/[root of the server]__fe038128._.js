...
function DraftsPage() {
    ...
    const fetchDocuments = async (page)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`http://localhost:3003/api/documents?page=${page}&limit=10`, {
                params: {}
            });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__fe038128._.js.map