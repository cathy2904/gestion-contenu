...
function UsersPage() {
    ...
    const fetchUsers = async ()=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('http://localhost:3003/api/users'); // ← backend NestJS
            setUsers(res.data);
        } catch (err) {
    ...
    const handleRoleChange = async (userId, newRole)=>{
        try {
            setUpdating(userId);
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].patch(`http://localhost:3003/api/users/${userId}/role`, {
                role: newRole
            });
            fetchUsers(); // refresh
        } catch (error) {
