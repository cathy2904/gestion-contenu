...
function EditPostPage() {
    ...
    const [imagePath, setImagePath] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditPostPage.useEffect": ()=>{
            fetch(`http://localhost:3000/posts/${id}`).then({
                "EditPostPage.useEffect": (res)=>res.json()
            }["EditPostPage.useEffect"]).then({
                "EditPostPage.useEffect": (data)=>{
                    setPost(data);
                    setTitle(data.title);
 ...
 //   )
 // }
_s(EditPostPage, "lwbRwwV8L/JEG2jlayIS6ThcBm0=", false, function() {
    return [
