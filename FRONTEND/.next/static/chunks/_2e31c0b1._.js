...
function ContentPage() {
    ...
    // plannification
    const [statut, setStatut] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    // Filtres
    ...
    const fetchContents = async (page)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('http://localhost:3003/api/content?page=${page}&limit=10', {
                params: {
                    page,
                    limit: 10,
                    user: user || undefined,
...
_s(ContentPage, "hSsFmwe3889gtjREnEM7KM8GpcU=");
_c = ContentPage;
var _c;
