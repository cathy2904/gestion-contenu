...
_s(EditPostForm, "p2lvc03G9B+guRi+OFEIrlByw4s=", false, function() {
    return [
...
function EditPostPage() {
    ...
    const fetchPost = async ()=>{
        ...
        try {
            setIsLoading(true);
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$post$2f$service$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPost"])(id);
